...
sed -e "s/__VWILDFLY__/${VWILDFLY}/g" wildfly/Dockerfile >"${DBUILD}/wildfly/Dockerfile"
cp wildfly/entrypoint.sh "${DBUILD}/wildfly/"
...
cp database/Dockerfile "${DBUILD}/database/"
...
cp httpd/Dockerfile "${DBUILD}/httpd/"
